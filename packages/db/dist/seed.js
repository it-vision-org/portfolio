    ...
    const products = [
        {
            ...
            description: "Lightweight everyday runner with responsive cushioning and breathable mesh upper.",
            basePrice: 129.99,
            isFeatured: true,
            isPublished: true,
        ...
        },
        {
            name: "Urban Flex Low",
            slug: "urban-flex-low",
            description: "Clean low-profile sneaker for casual wear. Soft insole and durable rubber outsole.",
            basePrice: 89.99,
            isFeatured: true,
            isPublished: true,
        ...
        },
        {
            name: "Trail Grip Pro",
            slug: "trail-grip-pro",
            description: "All-terrain shoe with extra grip and ankle support for outdoor trails.",
            basePrice: 159.99,
            isFeatured: false,
            isPublished: true,
            categoryId: running.id,
